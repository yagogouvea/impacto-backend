...
const API_BASE_URL = process.env.API_BASE_URL || 'https://api.impactopr.seg.br';

async function testarTempoCorrigidoProducao() {
  try {
    ...
    if (detalhadoResponse.data.length > 0) {
      ...
      if (ocorrenciaComTempo) {
        ...
        console.log('   Data Acionamento:', ocorrenciaComTempo.data_acionamento);
