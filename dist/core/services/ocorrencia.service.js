...
class OcorrenciaService {
    async list(filters = {}) {
        try {
            ...
            const prestadoresNomes = [...new Set(ocorrencias.map(oc => oc.prestador).filter((p) => Boolean(p)))];
            ...
            const clientesNomes = [...new Set(ocorrencias.map(oc => oc.cliente).filter((c) => Boolean(c)))];
            ...
            const prestadoresMap = new Map(prestadoresComDados.map(p => [p.nome, p]));
            // Criar mapa para busca rápida de clientes
            const clientesMap = new Map(clientesComDados.map(c => [c.nome, c]));
            ...
            const ocorrenciasComDadosCompletos = ocorrencias.map(oc => {
                ...
                return Object.assign(Object.assign({}, oc), { 
                    ...
                    valor_acionamento: (prestador === null || prestador === void 0 ? void 0 : prestador.valor_acionamento) || null, valor_hora_adc: (prestador === null || prestador === void 0 ? void 0 : prestador.valor_hora_adc) || null, valor_km_adc: (prestador === null || prestador === void 0 ? void 0 : prestador.valor_km_adc) || null, franquia_horas: (prestador === null || prestador === void 0 ? void 0 : prestador.franquia_horas) || null, franquia_km: (prestador === null || prestador === void 0 ? void 0 : prestador.franquia_km) || null, 
                    // Adicionar dados do cliente incluindo logo
                    cliente_logo: (cliente === null || cliente === void 0 ? void 0 : cliente.logo) || null, cliente_nome_fantasia: (cliente === null || cliente === void 0 ? void 0 : cliente.nome_fantasia) || null });
            });
