...
exports.domainSpecificHandler = exports.domainRedirectMiddleware = void 0;
/**
...
exports.domainRedirectMiddleware = domainRedirectMiddleware;
/**
 * Middleware para servir página específica baseada no domínio
 */
const domainSpecificHandler = (req, res) => {
    const host = req.get('host');
    if (host === 'cadastroprestador.impactopr.seg.br') {
...
exports.domainSpecificHandler = domainSpecificHandler;
