...
async function setupRailwayDatabase() {
  try {
    console.log('🚀 Configurando banco de dados Railway - Cliente Impacto...');
    ...
    try {
      ...
      console.log('💡 Tentando aplicar schema diretamente...');
      try {
    ...
    console.error('❌ Erro na configuração Railway:', error);
